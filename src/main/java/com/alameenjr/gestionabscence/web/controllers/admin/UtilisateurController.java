...
import com.alameenjr.gestionabscence.security.TokenProvider;
...
import com.alameenjr.gestionabscence.web.pojo.JWTToken;
import com.alameenjr.gestionabscence.web.pojo.LoginModel;
import com.alameenjr.gestionabscence.web.utils.Utilitaire;
...
public class UtilisateurController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginModel loginModel, HttpServletResponse response) {
        log.info(loginModel.getLogin());
        log.info(loginModel.getPassword());
